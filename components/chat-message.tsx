    ...
    <div className={`flex ${isUser ? "justify-end" : "justify-start"}`}>
      <div className={`flex max-w-[80%] ${isUser ? "flex-row-reverse" : "flex-row"} items-start gap-2`}>
        <div
          ...
          ${isUser ? "bg-gradient-to-br from-[#4f3dff] to-[#eeeeee]" : "bg-[#2a2a2a]"}
        `}
        >
          {isUser ? <User className="h-4 w-4 text-[#1c1c1c]" /> : <Bot className="h-4 w-4 text-[#4f3dff]" />}
        </div>
        ...
        <div
          ...
          ${
            isUser
              ? "bg-gradient-to-r from-[#4f3dff] to-[#eeeeee] text-[#1c1c1c]"

    ...
    try {
      ...
      return NextResponse.json(
        { 
          ...
          message: 'The Injective Agent could not be initialized due to missing dependencies or environment variables. Please check the server logs for more details.' 
        },
        { status: 500 }
      );
    }
